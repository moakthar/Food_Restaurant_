      ...
      setTimeout(function () {
        ...
        q.each(function () {
          ...
          for (var c = {}, e = 0; 2 > e; e++) {
            ...
            c[h + "transition-property"] =
              h + "transform, " + h + "filter, opacity";
  ...
  var y = {
      ...
      return this.each(function () {
        ...
        if (b.sortOnLoad) {
          ...
          d.isArray(b.sortOnLoad)
            ...
            : (d(b.sortSelector + "[data-sort=" + b.sortOnLoad + "]").addClass(
                "active"
              ),
              (c = b.sortOnLoad),
              (b.sortOnLoad = "desc"));
        ...
        d.each(f, function () {
          d(b.filterSelector + '[data-filter="' + this + '"]').addClass(
            "active"
          );
        });
    ...
    toGrid: function () {
      return this.each(function () {
        var e = this.config;
        "grid" != e.layoutMode &&
          ((e.layoutMode = "grid"), r(e.filter, null, null, d(this), e));
      });
    },
    toList: function () {
      return this.each(function () {
        var e = this.config;
        "list" != e.layoutMode &&
          ((e.layoutMode = "list"), r(e.filter, null, null, d(this), e));
      });
    },
    filter: function (e) {
      return this.each(function () {
      ...
      return this.each(function () {
        ...
        if (!c.mixing) {
          ...
          if (d.isArray(e)) {
            ...
            d(c.sortSelector + '[data-sort="' + e + '"]').addClass("active"),
              (b = e),
              (a = "desc");
    ...
    multimix: function (e) {
      return this.each(function () {
        ...
        c.mixing ||
          ...
          d(
            c.filterSelector + '[data-filter="' + multiOut.filter + '"]'
          ).addClass("active"),
